...
import { getPosition, isWithinGeofence, isOperatingHours, nextOpeningTime } from '../utils/geo.js'
import { getCurrentUser, saveUser } from '../utils/storage.js'
      ...
      <motion.div
        ...
        <div className="flex items-center gap-3 px-5 pt-5 pb-4 border-b border-white/8">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-white/40">{venue.city} · GPS {venue.geofence_radius}מ׳</p>
          </div>
          {canDismiss && (
              ...
              <motion.div key="profile" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}
                ...
                <div className="flex flex-col gap-2 pt-1">
                  <NeonButton variant="purple" size="lg" fullWidth onClick={confirmProfile}>
                    📍 {he ? 'אמת מיקום וכנס' : 'Verify Location & Join'}
                  </NeonButton>
